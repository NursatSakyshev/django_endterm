...
from .views import CategoryListCreateView, CategoryRetrieveUpdateDestroyView, ItemListCreateView, \
    ItemRetrieveUpdateDestroyView, ItemPhotoListCreateView, ShopRegisterView, ShopListView, ItemTransactionView
...
urlpatterns = [
    ...
    path('items/<int:pk>/transaction/', ItemTransactionView.as_view()),
