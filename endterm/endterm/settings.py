...
SECRET_KEY = "django-insecure-70kt@t53*ip4f@+=*!(caz$btz*lee$s3=83mhy36)1hh67=$+"
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=365*7),
...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Этот middleware должен быть здесь
